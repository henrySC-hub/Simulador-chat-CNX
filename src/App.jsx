      ...
      <main className="max-w-6xl mx-auto px-4 py-4 grid lg:grid-cols-12 gap-4">
        ...
        <section className="lg:col-span-9">
          ...
          <div className="text-[11px] text-neutral-400 mt-3 text-center">
            Abre <a className="underline" href="#/agente">#/agente</a> y <a className="underline" href="#/moderador">#/moderador</a> (misma room) en dos PCs o dos tabs. Para cambiar de sala: añade <code>?room=soporte1</code>.
          </div>
        </section>
      </main>
    </div>
